  ...
  <div class="flex gap-4 mb-2 px-4">
    ...
    <div class="flex flex-col gap-2 flex-1">
      <div class="relative border-4 border-yellow-900 rounded-xl bg-white/80 shadow p-2 pt-5">
        <div class="absolute -top-3 left-6 bg-white/80 px-2 text-yellow-900 font-bold tracking-widest text-x">角色姓名</div>
      ...
      <div class="relative border-4 border-yellow-900 rounded-xl bg-white/80 shadow p-2 pt-5">
        <div class="absolute -top-3 left-6 bg-white/80 px-2 text-yellow-900 font-bold tracking-widest text-x">職責</div>
